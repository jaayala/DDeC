classdef TSN_sleeping < handle
   ...
   methods     
       function this = TSN_sleeping(alpha)
          this.alpha = alpha;
       end;       
       ...
       function chosen_arm = select_arm(this, available_arms)
           
           minTests = max([2, (3-floor(2*this.alpha))]);
           ind_requiredTested_arm = find(this.count<minTests & available_arms(:)');
