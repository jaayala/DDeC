...
softmax_desc_data.LTE_model_files = LTE_model_files;
softmax_desc_data.convex_model_std = convex_model_std;
...
fprintf('Executing softmax desc...\n')

tao_0 = 1;
inputParameters.algo = softmax_descent_algo(tao_0);
...
for i = 1:length(LTE_model_files)
    ...
    softmax_desc_data.LTE.(['sc' num2str(i)]) = data.meanRegret;
end

save([saveFolder 'softmax_desc_data'], 'softmax_desc_data')
