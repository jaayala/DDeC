...
e_greedy_desc_log_data.LTE_model_files = LTE_model_files;
e_greedy_desc_log_data.convex_model_std = convex_model_std;
...
fprintf('Executing epsilon greedy desc log...\n')

inputParameters.algo = e_desc_log_greedy_algo;
...
for i = 1:length(LTE_model_files)
    ...
    e_greedy_desc_log_data.LTE.(['sc' num2str(i)]) = data.meanRegret;
end

save([saveFolder 'e_greedy_desc_log_data'], 'e_greedy_desc_log_data')
