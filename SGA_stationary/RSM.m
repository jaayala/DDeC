...
RSM_data.LTE_model_files = LTE_model_files;
RSM_data.convex_model_std = convex_model_std;
...
alphaC = 39.8927;
algo = ResponseSurfaceMethod;
algo.initilize(d, delta, nSamplesPerPoint, alphaF, alphaC)
...
for i = 1:length(LTE_model_files)
    ...
    RSM_data.LTE.(['sc' num2str(i)]) = data.meanRegret;
end

save([saveFolder 'RSM_data'], 'RSM_data')
rmpath(codeFolder)